...
class Moderation(commands.Cog):
        ...
        @commands.command(description="Kicks the member from the guild!")
        @commands.guild_only()
        ...
        @commands.command(description="Bans the member from the guild!")
        @commands.guild_only()
        @commands.has_guild_permissions(ban_members=True)
        ...
        @commands.command(description="Unbans the member's ID from the guild!")
        @commands.guild_only()
        @commands.has_guild_permissions(ban_members=True)
        ...
        @commands.command(description="Clears a provided amount of messages! (Default = 5)")
        @commands.guild_only()
